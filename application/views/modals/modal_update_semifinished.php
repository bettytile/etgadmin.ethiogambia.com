...
<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
    ...
    <form id="form-update-semifinished" method="POST">
    <input type="hidden" name="id" value="<?php echo $dataSemiFinished->id; ?>">
    <!-- <input type="text"  name="station" value="<?php echo $dataSemiFinished->id_station ; ?>"> -->
    <div class="input-group form-group">
      ...
      <option value="<?php echo $dataSemiFinished->store_location; ?>">
            <?php echo $dataSemiFinished->station; ?>
          </option>
        <?php
      ...
      <input type="date" class="form-control" placeholder="Date" min="0" name="activity_date" value="<?php echo $dataSemiFinished->activity_date ; ?>" aria-describedby="sizing-addon2">
    </div>
    ...
    <div class="input-group form-group">
            ...
            <input type="text" id="reference" onblur="addCharacter()" class="form-control" placeholder="Reference No" value="<?php echo $dataSemiFinished->reference_no ; ?>" name="reference_no"
	...
	<input type="hidden" id="issued" class="col-form-label" name="rstatus" value="<?php echo $dataSemiFinished->rstatus;?> ">
    ...
    <span class="input-group-addon" id="sizing-addon2">
      ...
      <input value="<?php echo $dataSemiFinished->code ."|". $dataSemiFinished->raw_material_type .""; ?>" class="form-control has-error"   name="id_product" aria-describedby="sizing-addon2" readonly>
    </div>
    ...
    <span class="input-group-addon" id="sizing-addon2">
      ...
      <input readonly="readonly" id="available_qty" value="<?php echo $dataSemiFinished->available_qty; ?>" class="form-control has-error" name="available_qty" aria-describedby="sizing-addon2" readonly>
    </div>
        ...
        <div class="input-group form-group">
            ...
            <input type="number" class="form-control" onkeyup="calculatedifference()" placeholder="Issued Quantity" id="issued_qty" name="issued_qty" value="<?php echo $dataSemiFinished->issued_qty; ?>"
                aria-describedby="sizing-addon2">
        </div>     
        <div class="input-group form-group">
            <span class="input-group-addon" id="sizing-addon2">
            ...
            <input type="number" class="form-control" onkeyup="calculatesum()" placeholder="Received Quantity" id="received_qty" name="received_qty" value="<?php echo $dataSemiFinished->received_qty; ?>"
                aria-describedby="sizing-addon2">
        </div> 
        <script>
