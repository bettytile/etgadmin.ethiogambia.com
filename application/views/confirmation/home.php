...
<div class="box">
  ...
  <!-- /.box-header -->
  <div class="box-body">
    <table id="list-data" class="table table-bordered table-striped responsive ">
      <thead>
        <tr>
          <th >Product Code</th>
          <th >RM Code</th>
      ...
      <?php
        foreach ($dataConfirmation as $pegawai) {
          ?>
          <tr>
            <td ><?php echo $pegawai->product_code; ?></td>
            <td ><?php echo $pegawai->rawmaterial_code; ?></td>
            <td ><?php echo $pegawai->preform_code; ?></td>
            <td><?php echo $pegawai->reference_no; ?></td>
            <!--<td><?php echo $pegawai->production_type; ?></td>-->
            <td ><?php echo $pegawai->qty_produced; ?></td>
            <td ><?php echo $pegawai->qty_damaged; ?></td>
            <td ><?php echo $pegawai->received_weight; ?></td>
            <td ><?php echo $pegawai->left_weight; ?></td>
            <td><?php echo $pegawai->shift; ?></td>
