...
class IssuedDataReport extends AUTH_Controller {
	...
	public function index() {
		...
		$data['dataIssued'] = $this->M_deliveryreport->select_all();
		...
		$data['page'] = "issueddatareport";
		$data['judul'] = "Issued Data";
		$data['deskripsi'] = "Manage Issued Data";

		$data['modal_production_report'] = show_my_modal('modals/modal_production_report', 'delivery-report', $data);

		$this->template->views('issueddatareport/home', $data);
	}

	public function show() {
		$data['dataIssued'] = $this->M_deliveryreport->select_all();
		$this->load->view('issueddatareport/home', $data);
	}
