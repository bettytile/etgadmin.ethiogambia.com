...
class RawMaterialReport extends AUTH_Controller {
	...
	public function index() {
		...
		$data['dataRawMaterial'] = $this->M_rawmaterial->select_all();
        $data['dataProduct'] = $this->M_product->select_all_rawmaterial();
