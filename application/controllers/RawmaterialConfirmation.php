...
class RawmaterialConfirmation extends AUTH_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('M_rawmaterial');
	...
	public function index() {
		...
		$data['dataRawMaterial'] = $this->M_rawmaterial->select_all_instock();
		...
		$data['page'] = "rawmaterialconfirmation";
		$data['judul'] = "Raw Material Data";
		$data['deskripsi'] = "Manage Raw Material Data";

		$data['modal_production_report'] = show_my_modal('modals/modal_production_report', 'stock-report', $data);

		$this->template->views('rawmaterialconfirmation/home', $data);
	}

	public function show() {
		$data['dataRawMaterials'] = $this->M_rawmaterial->select_all_instock();
		$this->load->view('rawmaterialconfirmation/home', $data);
	}
	...
	public function update() {
		...
		$data['dataRawMaterial'] = $this->M_rawmaterial->select_by_id($id);
        $data['dataProductionType'] = $this->M_productionType->select_all_ProductionType();
        $data['dataStation'] = $this->M_station->select_all_stations();
		$data['userdata'] = $this->userdata;

		echo show_my_modal('modals/modal_update_stockrawmaterial', 'update-stockRawmaterial', $data);
	}
	...
	public function prosesUpdate() {
		...
		$data = $this->input->post();
		if ($this->form_validation->run() == TRUE) {
			$result = $this->M_rawmaterial->update($data);
	...
	public function rmconfirm() {
		$id = $_POST['id'];
		$result = $this->M_rawmaterial->confirmationrm($id);
	...
	public function export() {
		...
		$data = $this->M_rawmaterial->select_all_instock();
