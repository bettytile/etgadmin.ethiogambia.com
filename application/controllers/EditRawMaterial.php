...
class EditRawMaterial extends AUTH_Controller {
	...
	public function index() {
		...
		$this->template->views('editrawmaterial/home', $data);
	}

	public function show() {
		$data['dataRawMaterial'] = $this->M_rawmaterial->select_all_instock();
		$this->load->view('editrawmaterial/list-data', $data);
	}
