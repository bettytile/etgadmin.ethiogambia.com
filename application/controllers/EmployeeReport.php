...
class EmployeeReport extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] = "employeereport";
		$data['judul'] = "Employee Report Data";
		$data['deskripsi'] = "Manage Employee Report Data";

		$data['modal_production_report'] = show_my_modal('modals/modal_production_report', 'production-report', $data);

		$this->template->views('employeereport/home', $data);
	}
