...
class SemiFinished extends AUTH_Controller {
	...
	public function index() {
		...
		$data['dataSemifinished'] = $this->M_preform->select_all();
		$data['dataProductType'] = $this->M_productType->select_all_productType();

		$data['page'] = "semifinished";
		$data['judul'] = "Preform Data";
		$data['deskripsi'] = "Manage Preform Data";

		$data['modal_insert_semifinished'] = show_my_modal('modals/modal_insert_semifinished', 'insert-preform', $data);

		$this->template->views('semifinished/home', $data);
	}

	public function show() {
		$data['dataSemifinished'] = $this->M_preform->select_all();
		$this->load->view('semifinished/list_data', $data);
	}
	...
	public function addProduct() {
		...
		if ($this->form_validation->run() == TRUE) {
			$result = $this->M_preform->insert($data);
	...
	public function update() {
		...
		$data['dataSemifinished'] = $this->M_preform->select_by_id($id);
		$data['dataProductType'] = $this->M_productType->select_all_productType();
		$data['userdata'] = $this->userdata;

		echo show_my_modal('modals/modal_update_preform', 'update-preform', $data);
	}
	...
	public function prosesUpdate() {
		...
		$data = $this->input->post();
		if ($this->form_validation->run() == TRUE) {
			$result = $this->M_preform->update($data);
	...
	public function delete() {
		$id = $_POST['id'];
		$result = $this->M_preform->delete($id);
	...
	public function export() {
		...
		$data = $this->M_preform->select_all();
