...
class ProductReport extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] = "productreport";
		$data['judul'] = "Product Report Data";
		$data['deskripsi'] = "Manage Product Report Data";

		$data['modal_production_report'] = show_my_modal('modals/modal_production_report', 'production-report', $data);

		$this->template->views('productreport/home', $data);
	}
