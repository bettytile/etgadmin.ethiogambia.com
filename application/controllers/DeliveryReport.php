...
class DeliveryReport extends AUTH_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('M_deliveryreport');
	...
	public function index() {
		...
		$data['dataDelivery'] = $this->M_deliveryreport->select_all();
		...
		$data['page'] = "deliveryreport";
		$data['judul'] = "Delivery Data";
		$data['deskripsi'] = "Manage Delivery Data";

		$data['modal_production_report'] = show_my_modal('modals/modal_production_report', 'delivery-report', $data);

		$this->template->views('deliveryreport/home', $data);
	}

	public function show() {
		$data['dataDelivery'] = $this->M_deliveryreport->select_all();
		$this->load->view('deliveryreport/list_data', $data);
	}
